...
class CctaSpider(CityScrapersSpider):
    ...
    start_urls = [
        (
            "https://ccta.primegov.com/api/v2/PublicPortal/ListArchivedMeetings"
        ...
        if "documentList" in item:
            for doc in item["documentList"]:
                if "compileOutputType" in doc and doc["compileOutputType"] == 1:
                    link = "https://ccta.primegov.com/Public/CompiledDocument/" + str(
                        doc["id"]
                    )
                else:
                    link = (
                        "https://ccta.primegov.com/Portal/Meeting"
