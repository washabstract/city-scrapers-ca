...
from city_scrapers.spiders.corona import CoronaSpider

freezer = freeze_time("2022-12-23")
freezer.start()

with open(join(dirname(__file__), "files", "corona.json"), "r", encoding="utf-8") as f:
